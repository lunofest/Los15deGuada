...
function updateTimer() {
  const targetDate = new Date("january 11, 2025 20:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '542995279930'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '542995279930'; // Número para el primer botón
  const recipientNumber2 = '542994125862'; // Número para el segundo botón
